    ...
    },
    {
      ...
      options: {
        allPageHeaders: [
          ...
          "Content-Security-Policy: default-src 'none'; font-src 'self' https://fonts.gstatic.com; frame-src https://www.youtube.com; img-src 'self' 'unsafe-inline' 'unsafe-eval'; media-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com;",
